    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        const existing = new Set(
          items
            .map((i) => (typeof i?.symbol === "string" ? i.symbol : ""))
            .filter(Boolean)
        );
        const filtered = results.filter((s) => {
          if (typeof s?.symbol !== "string") return false;
    ...
    <section style={{
      ...
      <div style={{
        ...
        <span style={{
          ...
          padding: "3px 8px", borderRadius: "6px", fontFeatureSettings: '"tnum" 1',
        }}>
          {items.length}/20
        </span>
      </div>
            ...
            {items.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  onHoverStart={(e) => {
                    const del = e.target?.closest?.("[data-wl-item]")?.querySelector?.(".wl-delete");
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      {item.price > 0 ? (
                        <p style={{ fontSize: "11px", color: "#3b4260", marginTop: "1px", fontFeatureSettings: '"tnum" 1' }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px", flexShrink: 0 }}>
                    ...
                    <motion.button
                      ...
                      disabled={isDeleting}
                      whileHover={{ scale: 1.1, backgroundColor: "rgba(244,63,94,0.12)" }}
                      whileTap={{ scale: 0.9 }}
                      style={{
